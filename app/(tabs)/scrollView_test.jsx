...
export default function ScrollViewTestScreen() {
  return (
    ...
    >
      <View>
        {" "}
        {/* 這個 View 內部不再需要 justify-center 和 items-center */}
        <Text className="text-3xl text-yellow-800 font-bold mb-4">
          這是分頁二 (ScrollView 測試頁)
        </Text>
        ...
        {/* 添加更多內容以測試滾動 */}
        <Text className="text-base text-gray-700 text-center mt-5">
          底部內容...
        </Text>
        <Text className="text-base text-gray-700 text-center">
          再加一些行...
